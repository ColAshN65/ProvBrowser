...
namespace Testing
{
    internal class AssemblyTest
    {
        ...
        static readonly string ApiKey = "222f7276509c47b8a634f721c7ba70e6";
        ...
        public async Task Main(string[] args)
        {
            ...
            var audioUrl = await UploadFileAsync("RecordResult.wav", httpClient);
            ...
            while (true)
            {
                ...
                if (status == "completed")
                {
                    ...
                    MessageBox.Show($"Transcript Text: {transcriptText}");
                    break;
                }
